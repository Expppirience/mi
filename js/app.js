(() => {
    ...
    (() => {
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".about__slider")) if (isMobile.any()) {
            ...
            if (document.querySelector(".feedback__slider")) {
                new core(".feedback__slider", {
                    ...
                    loop: true,
                    pagination: {
                        el: ".controls-slider-feedback__pagination",
                        clickable: true
                    },
                    navigation: {
                        nextEl: ".slider-feedback__controls .controls-slider-feedback__next",
                        prevEl: ".slider-feedback__controls .controls-slider-feedback__prev"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 1,
        ...
        const simepleBarRemover = (element, size) => {
            window.innerWidth < size ? delete element.dataset.simplebar : "";
        };
        const spollerBar = document.querySelector(".spollers-order__list");
        simepleBarRemover(spollerBar, 768);
        ...
        window.addEventListener("load", (e => {
            const lightBtns = document.querySelectorAll(".theme-switch-light");
            const darkBtns = document.querySelectorAll(".theme-switch-dark");
            const switchState = themeName => {
                if ("dark-theme" == localStorage.getItem("theme")) removeTheme("dark-theme"); else removeTheme("light-theme");
                const currentBtns = document.querySelectorAll(`input[value="${themeName}"`);
            ...
            const initTheme = () => {
                if (localStorage.getItem("theme")) switchState(`${localStorage.getItem("theme")}`); else switchState("light-theme");
            };
            initTheme();
            lightBtns.forEach((lightBtn => {
                lightBtn.addEventListener("click", (e => {
                    switchState("light-theme");
                }));
            }));
            darkBtns.forEach((darkBtn => {
                darkBtn.addEventListener("click", (e => {
                    switchState("dark-theme");
                }));
            }));
        }));
        window["FLS"] = false;
